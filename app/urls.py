...
from .views import landingview, productlistview, supplierlistview, addsupplier, addproduct, deleteproduct, confirmdeleteproduct, \
    edit_product_get, edit_product_post, searchsuppliers, products_filtered
